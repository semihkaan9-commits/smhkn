      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-10">
          <div>
            <h2 className="text-3xl font-bold text-[#805894] mb-2 flex items-center gap-2">
              <ImageIcon className="text-[#805894]" />
        ...
        {isAdmin && showForm && (
          <div className="bg-stone-50 p-6 rounded-xl shadow-inner mb-10 animate-fade-in-up border border-stone-200">
            <h3 className="text-lg font-bold mb-4 text-[#805894]">Galeriye Ekle</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex gap-4 mb-4">
                <button
                  type="button"
                  onClick={() => setUploadMode('URL')}
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${uploadMode === 'URL' ? 'bg-[#805894] text-white' : 'bg-gray-200 text-gray-700'}`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${uploadMode === 'FILE' ? 'bg-[#805894] text-white' : 'bg-gray-200 text-gray-700'}`}
                >
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-3 border border-gray-300 rounded-lg bg-white text-black focus:ring-2 focus:ring-[#805894]"
                  ...
                  {uploadMode === 'URL' ? (
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                      />
                      {url && <p className="text-xs text-[#805894] mt-1">Dosya seçildi.</p>}
                    </div>
                  )}
                </div>
              </div>
